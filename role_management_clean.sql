...
UPDATE hierarchy_levels SET reporting_to_level = 1 WHERE level = 2;
UPDATE hierarchy_levels SET reporting_to_level = 2 WHERE level = 3;
UPDATE hierarchy_levels SET reporting_to_level = 3 WHERE level = 4;
UPDATE hierarchy_levels SET reporting_to_level = 4 WHERE level = 5;
UPDATE hierarchy_levels SET reporting_to_level = 5 WHERE level = 6;
